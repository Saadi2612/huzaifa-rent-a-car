...
export type Car = {
  id: string;
  name: string;
  category: "Economy" | "Sedan" | "SUV" | "Executive" | "Van";
  seats: number;
  luggage: number;
...
export const FLEET: Car[] = [
  ...
  },
  {
    ...
    transmission: "Manual",
    fuel: "Petrol",
    rate: { withDriver: 7500, selfDrive: 5500 },
    tags: ["Daily commute"],
  ...
  },
  {
    ...
    transmission: "Automatic",
    fuel: "Petrol · CVT",
    rate: { withDriver: 15000, selfDrive: 12000 },
  ...
  },
  {
    ...
    transmission: "Automatic",
    fuel: "Diesel · 4x4",
    rate: { withDriver: 28000, selfDrive: null },
  ...
  },
  {
    ...
    transmission: "Automatic",
    fuel: "Diesel · 4x4",
    rate: { withDriver: 26000, selfDrive: null },
    tags: ["Rough terrain"],
    image: "/cars/revo.jpg",
  },
  {
    ...
    transmission: "Manual",
    fuel: "Diesel",
    rate: { withDriver: 22000, selfDrive: null },
    tags: ["Family trips", "Group tours"],
    image: "/cars/grand-cabin.jpg",
  },
  {
    id: "audi",
    name: "Audi A6",
    ...
    transmission: "Automatic",
    fuel: "Petrol",
    rate: { withDriver: 45000, selfDrive: null },
    tags: ["Luxury", "Bridal car"],
